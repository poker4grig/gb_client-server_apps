...
from lesson_2_6.server.stat_window import StatWindow
from lesson_2_6.server.config_window import ConfigWindow
from lesson_2_6.server.add_user import RegisterUser
from lesson_2_6.server.remove_user import DelUserDialog

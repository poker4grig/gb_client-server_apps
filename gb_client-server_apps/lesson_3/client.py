...
from client_storage import presence_msg
...
argv_parser.add_argument('-a', '--addr', nargs='?', default='127.0.0.1', help='help')
...
client_socket.send(json.dumps(presence_msg).encode('utf-8'))
while True:

"""Модуль отрисовки главного окна клиента."""
...
from lesson_2_7.common.errors import ServerError
from lesson_2_7.common.variables import MESSAGE_TEXT, SENDER
...
class ClientMainWindow(QMainWindow):
    ...
    def history_list_update(self):
        """Заполняет соответствующий QListView историей переписки с
        текущим собеседником.
        """
    ...
    def select_active_user(self):
        """Обрабатывает события двойного клика по списку контактов."""
    ...
    def add_contact(self, new_contact):
        """Метод добавляет контакт в серверную и клиентскую BD.
    ...
    def delete_contact_window(self):
        """Создает окно удаления контакта."""
    ...
    def message(self, message):
        ...
        Выполняет дешифровку поступаемых сообщений и их сохранение в истории
        сообщений. Запрашивает пользователя если пришло сообщение не от
        текущего собеседника. При необходимости меняет собеседника.
        """
        ...
        if sender == self.current_chat:
            ...
            if self.database.check_contact(sender):
                ...
                if self.messages.question(
                    ...
                    f'открыть чат с ним?', QMessageBox.Yes, QMessageBox.No) \
                        == QMessageBox.Yes:
                ...
                if self.messages.question(
                    ...
                    self.database.save_message(
                        self.current_chat, 'in', decrypted_message.decode(
                            'utf-8'))
                    self.set_active_user()
    ...
    def make_connection(self, trans_obj):
        """Обеспечивает соединение сигналов и слотов."""

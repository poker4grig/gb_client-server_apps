...
from lesson_2_7.server.stat_window import StatWindow
from lesson_2_7.server.config_window import ConfigWindow
from lesson_2_7.server.add_user import RegisterUser
from lesson_2_7.server.remove_user import DelUserDialog

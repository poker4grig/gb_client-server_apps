"""Модуль сетевого взаимодействия с клиентом."""
...
from lesson_2_7.common.decos import login_required
from lesson_2_7.common.descryptors import Port
from lesson_2_7.common.utils import get_message, send_message
from lesson_2_7.common.variables import MAX_CONNECTIONS, DESTINATION, SENDER, \
    ACTION, PRESENCE, TIME, USER, MESSAGE, MESSAGE_TEXT, EXIT, ERROR, \
    ACCOUNT_NAME, RESPONSE_200, RESPONSE_400, GET_CONTACTS, RESPONSE_202, \
    LIST_INFO, ADD_CONTACT, REMOVE_CONTACT, USERS_REQUEST, DATA, \
    PUBLIC_KEY_REQUEST, RESPONSE_511, RESPONSE, PUBLIC_KEY, RESPONSE_205
...
class MessageProcessor(threading.Thread):
    ...
    Принимает соединения, словари - пакеты от клиентов, обрабатывает
    ...
    def run(self):
        ...
        while self.running:
            ...
            try:
                ...
                LOG.error(f'Ошибка работы с сокетами: {err.errno}')
            ...
            if recv_data_lst:
                for client_with_message in recv_data_lst:
                    try:
                        ...
                        LOG.debug(f'Getting data from client exception.',
                                  exc_info=err)

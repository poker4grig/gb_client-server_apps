...
def login_required(func):
    ...
    авторизованных клиентов. За исключением передачи словаря-запроса
    на авторизацию. Если клиент не авторизован, генерирует исключение
    TypeError.
    """
    ...
    def checker(*args, **kwargs):
        ...
        from pack_server.server.server import MessageProcessor
        from client_and_server_app.common.variables import ACTION, PRESENCE

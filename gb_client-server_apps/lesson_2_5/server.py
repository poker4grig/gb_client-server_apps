...
from constants_server import PORT, TIMEOUT, PRESENCE_RESPONSE, \
    RESPONSE_202, RESPONSE_200, RESPONSE_400
...
class Server(threading.Thread, metaclass=ServerVerifier):
    ...
    def process_client_message(self, message, client):
        ...
        # Если это сообщение, то добавляем его в очередь сообщений. проверяем наличие в сети. и отвечаем.
                ...
                and 'from' in message and 'text' in message and self.names[message['from']] == client:
...
def main():
    ...
    listen_address, listen_port = server_argv(config['SETTINGS']['Default_port'], config['SETTINGS']['Listen_Address'])
    ...
    def save_server_config():
        ...
        try:
            ...
            if 1023 < port < 65536:
                ...
                message.warning(config_window, 'Ошибка', 'Порт должен быть от '
                                                         '1024 до 65536')

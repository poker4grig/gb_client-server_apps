...
# выравниванием и разным фоном. Записи в обратном порядке, поэтому выбираем
# их с конца и не более 20
    ...
    def add_contact(self, new_contact):
        try:
            ...
            if err.errno:
                self.message.critical(self, 'Ошибка', 'Потеряно соединение с '
                                                      'сервером!')
                self.close()
            self.message.critical(self, 'Ошибка', 'Таймаут соединения!')
        else:
    ...
    def delete_contact_window(self):
        ...
        remove_dialog.btn_ok.clicked(lambda: self.delete_contact(remove_dialog))
        remove_dialog.show()
    ...
    def send_message(self):
        ...
        try:
            ...
            LOG.debug(f'Отправлено сообщение для {self.current_chat}: '
                         f'{message_text}')
            self.history_list_update()
    ...
    def message(self, sender):
        ...
        # Если есть, спрашиваем о желании открыть с ним чат и открываем при
        # желании
